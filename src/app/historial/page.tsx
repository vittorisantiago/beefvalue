  ...
  useEffect(() => {
    const fetchQuotations = async () => {
      ...
      if (error) {
        ...
        // Mapear los datos para manejar business como array y tomar el primer elemento
        const mappedQuotations: Quotation[] = (data || []).map((item) => {
          // Si business es un array, tomar el primer elemento
          ...
          return {
            ...
            business:
              businessObj && businessObj.name
                ...
                : { name: "Sin negocio" }, // Manejar el caso donde business es null o no tiene name
