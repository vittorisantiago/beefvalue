        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-30">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-md shadow-lg">
            ...
            <p className="text-lg text-[var(--foreground)] mb-6">
              ¿Estás seguro de que quieres salir? Los cambios no guardados se
              perderán.
            </p>
            <div className="flex justify-end gap-4">
              ...
              <button
                onClick={confirmExit}
                className="px-5 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 transition-all cursor-pointer text-lg font-medium"
              >
                Salir
              </button>
            </div>
