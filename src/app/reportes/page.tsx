...
interface BusinessData {
  name: string;
  totalGain: number;
  count?: number; // Añadido para contar cotizaciones
}
...
export default function Reportes() {
  ...
  const processBusinessData = (): BusinessData[] => {
    ...
    quotations.forEach((q) => {
      ...
      // Sumar el valor absoluto de difference_usd para reflejar el mayor beneficio real
  ...
  const businessGainChartOptions = {
    ...
    plugins: {
      ...
      tooltip: {
        callbacks: {
          label: (context: TooltipItem<"bar">) => {
            const label = context.label || "";
            // Usar context.parsed.x para gráficos horizontales
    ...
    scales: {
      ...
      y: {
        ...
        ticks: {
          color: "#E5E7EB",
          // Mostrar el valor real sin formatear a string
  ...
  // Logo directo desde public/images/vaca.png
  ...
  const handleDownload = async (type: "Gráfico" | "Informe Escrito") => {
    ...
    doc.addImage(img, "PNG", pageWidth - 35, 10, 18, 18); // Esquina superior derecha
    ...
    if (type === "Gráfico") {
      ...
      doc.setFillColor(22, 163, 74); // Verde más oscuro (green-600)
      doc.rect(0, 0, pageWidth, 28, "F");
      doc.addImage(img, "PNG", 12, 6, 14, 14); // Logo a la izquierda
      doc.setFontSize(22);
      ...
      // --- KPIs en 2x2 (más grandes) ---
      // Capturar las 4 tarjetas KPI y combinarlas en un canvas 2x2
      const kpiSelectors = [
      ...
      // Combinar los 4 canvas en un grid 2x2
      ...
      // --- Gráficos con títulos y leyendas en negro ---
      ...
      const chartSections = [
        ...
        },
        {
          ...
          table: businessData
            .map((d, i) => `${d.name}: ${d.count} (${colorNames[i] || ""})`)
            .join("\n"),
        },
        {
      ...
      for (const section of chartSections) {
        ...
        if (el) {
          // Forzar fondo blanco y documentar que los ejes/labels deben estar en negro en Chart.js
          const originalBg = el.style.background;
          el.style.background = "#fff";
          // Título SOLO si entra en la hoja
          let showTitle = true;
          // Medir altura estimada del gráfico
          ...
          if (y + 14 + imgHeight > 280) {
            ...
            y = 34;
            showTitle = true; // Solo mostrar título en la nueva hoja
          }
          if (showTitle) {
            doc.setFontSize(16);
        ...
        // Descripción y tabla/leyenda en negro
        doc.setFontSize(11);
        doc.setTextColor(0, 0, 0);
      ...
      // Resumen de KPIs en recuadro
      doc.setFillColor(255, 255, 255);
      doc.roundedRect(12, y, pageWidth - 24, 32, 4, 4, "F");
      doc.setFontSize(15);
      doc.setTextColor(22, 163, 74); // Verde más oscuro
      doc.setFont("helvetica", "bold");
      ...
      doc.setFont("helvetica", "normal");
      y += 15;
      // Sin emojis, solo texto claro y alineado
      doc.text(`Total Cotizaciones: ${totalQuotations}`, 18, y);
      y += 7;
      // Unificar mayor diferencia y negocio/fecha en una sola línea
