    ...
    try {
      ...
      if (data.user) {
        ...
        if (groupError || !groupData) {
          setError("Grupo 'Usuario' no disponible.");
          return;
        }
        ...
        if (userGroupError) {
          setError(
            "Error al asignar grupo: " +
              (userGroupError.message || "Intenta de nuevo.")
          );
          return;
        }
        setSuccess(true);
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-gray-800">
      <div className="w-full max-w-lg bg-gray-900 border border-gray-700 rounded-xl p-8 space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-400">Regístrate</p>
        </div>
        ...
        {success && (
          <div className="bg-emerald-900/50 border border-emerald-700 rounded-md p-4 text-center text-emerald-200">
            ...
            <p className="text-sm">
              Redirigiendo al login en {redirectSeconds} segundos...
            </p>
          </div>
        )}
